...
export default function Diary() {
  ...
  function handleEdit() {
    dispatch(diaryActions.toEditDiary(currentDiary.id));
  ...
  return (
    <div className="diary">
      <h2 className="main-h2">{currentDiary.title}</h2>
      <span className="diary-date">{currentDiary.date}</span>
      <p className="diary-content">{currentDiary.content}</p>
